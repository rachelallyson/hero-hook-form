...
- **RHF type mismatch** - Field names or `defaultValues` don't match schema/type
- **Errors not visible** - Custom UI doesn't render error props
...
<Tip>
Using Zod schema inference ensures your types always match your validation rules.
</Tip>
...
const { debouncedTrigger } = useDebouncedValidation(form, { delay: 300 });
```
...
1. Check the [API Reference](../api/README) for detailed documentation
2. Look at the [Examples](../recipes/examples) for working code
3. Check the [FAQ](../faq) for common questions
4. Search [GitHub Issues](https://github.com/rachelallyson/hero-hook-form/issues)
...
- [Error Handling Guide](./guides/error-handling) - Learn about validation strategies
- [Testing Guide](./guides/testing) - Test your forms properly
