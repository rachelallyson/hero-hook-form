...
<Info>
**Peer Dependencies**: Make sure you also have `react`, `react-dom`, `react-hook-form`, and HeroUI components installed. You can install either the all-in-one `@heroui/react` package or individual `@heroui/*` packages as needed.
</Info>
