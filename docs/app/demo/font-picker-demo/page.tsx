  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p className="text-gray-600 mb-6">
        This demo showcases the enhanced font picker with complete Google Fonts
        data from react-fontpicker (1,785+ fonts), instant font previews,
        intelligent 4-variant loading, and font loading detection.
      </p>
      ...
      <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
          ...
          (1,785+ fonts). Pre-rendered SVG sprites provide instant previews
          without any network requests.
        </p>
        <div className="text-xs text-gray-500 dark:text-gray-400">
          <strong>Sprite System:</strong> Pre-rendered SVG sprites • 1,785+
          Google Fonts • Zero loading time • Smart preview text • CSS sprite
          positioning
        </div>
      </div>
