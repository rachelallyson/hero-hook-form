...
const EnhancedFeaturesPage = () => {
  ...
  const advancedFields = advancedBuilder
    ...
    .conditionalField("advancedField", (data) => data.showAdvanced === true,
    ...
    .fieldArray("items", "Items", 
      createFieldArrayBuilder("items")
        ...
        .field("input", "value", "Item Value", { placeholder: "Enter item value" })
        .build()
    , {
      min: 1,
      max: 5,
    ...
    .conditionalField("sectionField1", (data) => data.showSection === true,
      createField("input", "sectionField1", "Section Field 1", { 
        placeholder: "Enter section field 1" 
      })
    )
    .conditionalField("sectionField2", (data) => data.showSection === true,
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600 mb-4">
          This form automatically generates Zod schema from field definitions. Notice how we define validation rules directly in the field options (minLength, pattern) and the schema is created automatically.
        </p>
        ...
        <ZodForm
          ...
          onSubmit={(data) => {
            ...
            alert(`Type-inferred form submitted: ${JSON.stringify(data, null, 2)}`);
          }}
