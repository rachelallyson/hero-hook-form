...
const userFormFields = createAdvancedBuilder<UserForm>()
  ...
  .conditionalField("phone", (data) => data.contactMethod === "phone" || data.contactMethod === "both",
    createField("input", "phone", "Phone Number", { type: "tel", placeholder: "Enter your phone number" })
  )
  .fieldArray("addresses", "Addresses", 
  ...
  .fieldArray("emergencyContacts", "Emergency Contacts", 
    createFieldArrayItemBuilder<{ name: string; relationship: string; phone: string }>()
...
const productFormConfig = createAdvancedBuilder<ProductForm>()
  ...
  .field("textarea", "description", "Description", { placeholder: "Enter product description" })
  .field("input", "price", "Price", { type: "number", placeholder: "Enter price" })
  ...
  .field("input", "tags", "Tags", { placeholder: "Enter tags separated by commas" })
  .build();
      ...
      <section className="bg-gray-50 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-lg shadow">
            <h3 className="font-semibold text-gray-900 mb-2">Conditional Fields</h3>
