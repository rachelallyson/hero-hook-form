...
const createInputField = (name: keyof ContactFormData, label: string, inputProps?: any) => ({
  label,
  name,
  type: "input",
...
const createTextareaField = (name: keyof ContactFormData, label: string, textareaProps?: any) => ({
  label,
  name,
  type: "textarea",
...
const createSelectField = (name: keyof ContactFormData, label: string, options: any[]) => ({
  label,
  name,
  type: "select",
  options,
...
const contactFields = [
  ...
  createTextareaField("message", "Message", { placeholder: "Tell us about your project..." }),
    ...
    <div className="max-w-2xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          This form uses helper functions to avoid repetitive "as const" assertions.
        </p>
      </div>
